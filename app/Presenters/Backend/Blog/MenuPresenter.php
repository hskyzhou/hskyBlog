...
namespace App\Presenters\Backend\Blog;
...
class MenuPresenter{
	...
	private function dealMenus($menus, $level, $menuRelations, &$menuStr = ""){
		foreach($menus as $menu){
			...
			if($level == 1){
		        $menuStr .= '		<a href="'.route('blog.menu.create', ['id' => $menu->id]).'" class="addMenu" data-target="#ajax" data-toggle="modal"><span class="fa fa-plus"></span></a>';
			}
	        $menuStr .= '		<a href="'.route('blog.menu.edit', ['id' => $menu->id]).'" class="editMenu" data-target="#ajax" data-toggle="modal"><span class="fa fa-pencil"></span></a>';
	        $menuStr .= '		<a data-url="'.route('blog.menu.destroy', [$menu->id]).'" class="deleteMenu"><span class="fa fa-trash"></span></a>';
			$menuStr .= '	</div>';
			$menuStr .= '</div>';
