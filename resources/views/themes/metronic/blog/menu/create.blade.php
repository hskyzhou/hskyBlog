        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <form role="form" class="form-horizontal" method="post">
                    <input class="form-add" type="hidden" name="parent_menu_id" value="{{$parentMenu ? $parentMenu->id : 0}}">
                    <div class="form-body">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-10">
                                <button type="button" class="btn blue filter-store createMenu" data-url="{{route('blog.menu.store')}}">提交</button>
                            </div>
                        </div>
                    </div>
                </form>
