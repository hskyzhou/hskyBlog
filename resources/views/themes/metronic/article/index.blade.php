...
<h3 class="page-title">
  ...
  <span class="caption-subject font-dark sbold uppercase">{{trans('backend.article.manage')}}</span>
</h3>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div class="btn-group">
                      <a href="{{route('article.create')}}" class="btn blue btn-outline btn-circle filter-add">
                    ...
                    <div class="btn-group btn-group-devided" data-toggle="buttons">
                        ...
                        <a data-url="{{route('article.delete.more')}}" class="btn red btn-outline btn-circle filter-delete-more" href="javascript:;">
                            <i class="{{trans('button.icon.delete')}}"></i>
                            <span class="hidden-xs">{{trans('button.text.delete')}}</span>
                        </a>

                        <a data-url="{{route('article.restore.more')}}" class="btn green btn-outline btn-circle filter-restore-more" href="javascript:;">
                            <i class="{{trans('button.icon.restore')}}"></i>
                            <span class="hidden-xs">{{trans('button.text.restore')}}</span>
                        </a>

                        <a data-url="{{route('article.destroy.more')}}" class="btn red btn-outline btn-circle filter-full-delete-more" href="javascript:;">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="5%">{{trans('label.article.name')}}</th>
