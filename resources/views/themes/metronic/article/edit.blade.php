...
<h3 class="page-title">
  ...
  <span class="caption-subject font-dark sbold uppercase">{{trans('backend.article.update')}}</span>
</h3>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
<div class="row">
              ...
              <form action="{{route('article.store')}}" class="form-horizontal" method="post">
                  ...
                  <div class="form-body">
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-8">
                              <input type="text" class="form-control" placeholder="" name="short_name" value="{{$info->short_name}}">
                              <div class="form-control-focus"> </div>
                              <span class="help-block">Some help goes here...</span>
                          </div>
                      </div>
                        ...
                        <div class="col-md-8">
                          <div class="md-radio-inline">
                              <div class="md-radio has-success">
                                  <input type="radio" id="radio53" name="status" class="md-radiobtn form-add" value="1" @if($info->status == getStatusActive()) checked @endif>
                                  <label for="radio53">
                                      <span></span>
                              ...
                              <div class="md-radio has-error">
                                  <input type="radio" id="radio54" name="status" class="md-radiobtn form-add checked" value="2" @if($info->status == getStatusClose()) checked @endif>
                                  <label for="radio54">
                                      <span></span>
                                      <span class="check"></span>
