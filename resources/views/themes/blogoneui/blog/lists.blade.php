...
@section('content')
	<!-- Hero Content -->
	<div class="bg-image" style="background-image: url('assets/img/photos/photo24@2x.jpg');">
	    ...
	    <div class="push-50-t push-50">
	        <div class="row">
	            ...
	            <div class="col-md-4 visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
	                <a class="block block-link-hover2" href="frontend_blog_story.html">
	                    <img class="img-responsive" src="assets/img/photos/photo21.jpg" alt="">
	                    <div class="block-content">
	                        <div class="font-s12 push">
	                            <em class="pull-right">10 min</em>
	                            <span class="text-primary">Rebecca Gray</span> on July 16, 2015
	                        </div>
	                ...
	                <a class="block block-link-hover2" href="frontend_blog_story.html">
	                    ...
	                    <div class="block-content">
	                        <div class="font-s12 push">
	                            ...
	                            <span class="text-primary">Eugene Burke</span> on July 13, 2015
	                        </div>
	                ...
	                <a class="block block-link-hover2" href="frontend_blog_story.html">
	                    ...
	                    <div class="block-content">
	                        <div class="font-s12 push">
	                            ...
	                            <span class="text-primary">Emma Cooper</span> on July 6, 2015
	                        </div>
	                ...
	                <a class="block block-link-hover2" href="frontend_blog_story.html">
	                    ...
	                    <div class="block-content">
	                        <div class="font-s12 push">
	                            ...
	                            <span class="text-primary">Amanda Powell</span> on June 21, 2015
	                        </div>
	                ...
	                <a class="block block-link-hover2" href="frontend_blog_story.html">
	                    ...
	                    <div class="block-content">
	                        <div class="font-s12 push">
	                            ...
	                            <span class="text-primary">George Stone</span> on June 16, 2015
	                        </div>
	                ...
	                <a class="block block-link-hover2" href="frontend_blog_story.html">
	                    ...
	                    <div class="block-content">
	                        <div class="font-s12 push">
	                            ...
	                            <span class="text-primary">Ryan Hall</span> on June 1, 2015
	                        </div>
	            ...
	            <div class="col-md-4 visibility-hidden" data-toggle="appear" data-offset="50" data-class="animated fadeIn">
	                <a class="block block-link-hover2" href="frontend_blog_story.html">
	                    ...
	                    <div class="block-content">
	                        <div class="font-s12 push">
	                            <em class="pull-right">9 min</em>
	                            <span class="text-primary">Ashley Welch</span> on May 19, 2015
	                        </div>
	                ...
	                <a class="block block-link-hover2" href="frontend_blog_story.html">
	                    ...
	                    <div class="block-content">
	                        <div class="font-s12 push">
	                            ...
	                            <span class="text-primary">Helen Silva</span> on May 10, 2015
	                        </div>
	                ...
	                <a class="block block-link-hover2" href="frontend_blog_story.html">
	                    ...
	                    <div class="block-content">
	                        <div class="font-s12 push">
	                            ...
	                            <span class="text-primary">Bruce Edwards</span> on May 2, 2015
	                        </div>
